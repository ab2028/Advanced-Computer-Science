...
public class Student {
    ...
    public Student(String name, String password, String email) {
        // test blank name, password, email, invalid email, name containing @, name alr taken
    ...
    public String resetPassword() {
        // test missing name, generated password less than 8 chars
    ...
    public Assignment submitAssignment(String title, String description) {
        // test missing assignment storage, assignment limit reached, blank title, blank description
        if (assignments == null) {
