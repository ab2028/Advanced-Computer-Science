...
public class CustomerTester {
    public static void main(String[] args) {
        ...
        System.out.println("Boosting Customer 1's points by 24.234%.");
        customer1.boostPoints(24.234);
        System.out.println("Customer 1's new points total: " + customer1.getRewardPoints());
