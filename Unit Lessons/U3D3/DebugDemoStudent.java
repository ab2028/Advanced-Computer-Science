...
// for this class only need illegal argument exception
public class DebugDemoStudent {
    ...
    public static int getFifthElement(int[] arr) {
        if (arr == null) {
            throw new NullPointerException("Invalid array; null");
        }
        if (arr.length < 6) {
    ...
    public static int getStringLength(String str) {
        if (str == null) {
            throw new NullPointerException("String is null. No length.");
        }
        return str.length();
    }
    ...
    public static int middleNameLength(String[] names) {
        if (names == null) { // always check null before array.length
            throw new NullPointerException("Array is null. Invalid.");
        }
        if (names.length < 2) {
            throw new ArrayIndexOutOfBoundsException("Index out of bounds. Name too short.");
        }
        if (names[1] == null) {
            throw new NullPointerException("Middle name is null, invalid.");
        }
    ...
    public static boolean isEqualIgnoreCase(String str1, String str2) {
        if (str1 == null || str2 == null) {
            throw new NullPointerException("Null string, invalid.");
        }
    ...
    public static String stringEnds(String str, int n) {
        if (str == null) {
            ...
            throw new StringIndexOutOfBoundsException("String is too short.");
        }
        return str.substring(0, n) + str.substring(str.length() - n); // just str ?
    }
    ...
    // can also set 1 and -1 and multiply, without if statement
